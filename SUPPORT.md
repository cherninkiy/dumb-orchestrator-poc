...
- [`README.md`](README.md) — quick start, CLI reference, architecture overview
- [`CONTRIBUTING.md`](CONTRIBUTING.md) — development setup, testing, and contribution guidelines

## Scope

This is a research proof-of-concept. Support is provided on a best-effort basis by the maintainer(s).
